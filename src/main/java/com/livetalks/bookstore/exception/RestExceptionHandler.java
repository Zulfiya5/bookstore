package com.livetalks.bookstore.exception;

import com.livetalks.bookstore.model.response.ApiResult;
import com.livetalks.bookstore.model.response.ErrorData;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<?> exceptionHandling(HttpMessageNotReadableException ex) {
        ...
        return ResponseEntity
                ...
                .body(ApiResult.errorResponse("Wrong parameter type"));
    }
    ...
    public ResponseEntity<?> exceptionHandling(AccessDeniedException ex) {
        ...
        return ResponseEntity
                ...
                .body(ApiResult.errorResponse("Access Denied"));
    }
